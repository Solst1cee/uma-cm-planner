...
**M4 (Skill Acquisition Planner) shipped** (2026-06-13, image-based UI: plan header + inventory + coverage matrix w/ parent spark columns + deck suggester + contingency; `/parents` CRUD; 360 curated WebP icons). **Engine-first foundation + M1 groundwork + M2 + M3 timeline merged 2026-06-15:**
