...
**M4 rebuild — next up (2026-06-19):** the primary planner surface, inventory transfer workflow, unique-skill chart, and acquirable white/gold/inherited-skill chart are live. Resume with **card-hint sourcing (§3)**, Uma **innate/release/usable-here columns**, then **HP / velocity / skill-activation zones** on the track (requires the engine per-frame run trace / `chartData`). Current handoffs: [module-4](docs/modules/module-4-skill-acquisition.md), [inventory](docs/superpowers/plans/2026-06-18-m4-plan-inventory-card-handoff.md), [sidebar](docs/superpowers/plans/2026-06-18-m4-sidebar-polish-handoff.md), and [track setup](docs/superpowers/plans/2026-06-18-m4-track-setup-card-handoff.md).
