 ...
 */
const DIRECT_OVERRIDE_FILES = new Set([
  'timeline_overrides.json',
  'unique_effect_text_overrides.json',
  'skill_categories_overrides.json',
  'skill_details_overrides.json',
  'uma_event_details_overrides.json',
  'uma_events_overrides.json',
]);
