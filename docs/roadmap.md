...
| **M1 Inheritance workbench** | **🟧 active** | **from the 2026-06-25 handoff; built card-by-card M1.0–M1.8 (see section). M1.0–M1.3 done + shipped in PR #12 (893 tests); M1.4 (inheritance/parents card) next. Importer/data follow-on.** |
