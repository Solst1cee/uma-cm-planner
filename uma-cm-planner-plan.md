...
|---|---|---|
| [jalbarrang/umalator-global](https://github.com/jalbarrang/umalator-global) | **The engine we vendor** (`src/sim/`) | TypeScript + Vite + pnpm; ships (a) web app, (b) simulation engine, (c) data tooling incl. `pnpm run db:fetch` to pull `master.mdb` and extraction scripts. **GPL-3.0** — see §4. **Our pin is v0.14.2 (2026-06-05); upstream now v0.18.0 (2026-06-22) — ~7 releases ahead → bump tracked in [docs/engine-update-todo.md](docs/engine-update-todo.md).** |
