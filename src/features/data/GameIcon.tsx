...
import { cardArtPath, cardIconPath, rankIconPath, skillIconPath, uiIconPath, umaIconPath } from '@/core/icons';
import { BASE_URL, useGameData } from '@/features/data/gameData';

export type GameIconKind = 'skill' | 'card' | 'card-art' | 'uma' | 'ui' | 'rank';
